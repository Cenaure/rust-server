...
#[openapi(
    paths(
        ...
        handlers::anime_handler::create_anime,
        handlers::anime_handler::update_anime,
    ...
    components(schemas(
        ...
        jikan_integration::common::structs::common::Images,
        jikan_integration::common::structs::common::WebpImage,
        jikan_integration::common::structs::common::JpgImage,
